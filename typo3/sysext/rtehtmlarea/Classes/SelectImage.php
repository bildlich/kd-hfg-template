...
/*]]>*/
		...
		$JScode = '
			...
			function setImageProperties() {
				...
				if (selectedImageRef) {
					...
					if (document.imageData.iPaddingTop) {
						if (document.imageData.iPaddingTop.value != "") {
							selectedImageRef.style.top = document.imageData.iPaddingTop.value;
						} else {
							selectedImageRef.style.top = "";
						}
					}
					if (document.imageData.iPaddingRight) {
						if (document.imageData.iPaddingRight.value != "") {
							selectedImageRef.style.right = document.imageData.iPaddingRight.value;
						} else {
							selectedImageRef.style.right = "";
						}
					}
					if (document.imageData.iPaddingBottom) {
						if (document.imageData.iPaddingBottom.value != "") {
							selectedImageRef.style.bottom = document.imageData.iPaddingBottom.value;
						} else {
							selectedImageRef.style.bottom = "";
						}
					}
					if (document.imageData.iPaddingLeft) {
						if (document.imageData.iPaddingLeft.value != "") {
							selectedImageRef.style.left = document.imageData.iPaddingLeft.value;
						} else {
							selectedImageRef.style.left = "";
						}
					}
			...
			function insertImagePropertiesInForm() {
				...
				if (selectedImageRef) {
					...
					if (document.imageData.iPaddingTop) {
						var padding = selectedImageRef.style.top ? selectedImageRef.style.top : selectedImageRef.vspace;
						if (isNaN(parseInt(padding)) || parseInt(padding) == 0) { padding = ""; }
						document.imageData.iPaddingTop.value = padding;
					}
					if (document.imageData.iPaddingRight) {
						padding = selectedImageRef.style.right ? selectedImageRef.style.right : selectedImageRef.hspace;
						if (isNaN(parseInt(padding)) || parseInt(padding) == 0) { padding = ""; }
						document.imageData.iPaddingRight.value = padding;
					}
					if (document.imageData.iPaddingBottom) {
						var padding = selectedImageRef.style.bottom ? selectedImageRef.style.bottom : selectedImageRef.vspace;
						if (isNaN(parseInt(padding)) || parseInt(padding) == 0) { padding = ""; }
						document.imageData.iPaddingBottom.value = padding;
					}
					if (document.imageData.iPaddingLeft) {
						var padding = selectedImageRef.style.left ? selectedImageRef.style.left : selectedImageRef.hspace;
						if (isNaN(parseInt(padding)) || parseInt(padding) == 0) { padding = ""; }
	...
	protected function setMaximumImageDimensions() {
		...
		if (!$this->plainMaxWidth) {
			$this->plainMaxWidth = 650;
		}
		if (!$this->plainMaxHeight) {
			$this->plainMaxHeight = 650;
		}
		...
		if (!$this->magicMaxWidth) {
			$this->magicMaxWidth = 650;
		}
		if (!$this->magicMaxHeight) {
			$this->magicMaxHeight = 100000;
		}
	}
