...
return array (
  ...
  array (
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/sdjxmlsitemap2/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/sdjseoog/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/sdjsectionnav/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/sdjnews/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/sdjimagegroups/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/sdjhfgkd20/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
    ...
    array (
      'state' => 'active',
      'packagePath' => 'typo3conf/ext/fl_realurl_image/',
      'classesPath' => 'Classes/',
      'suggestions' => 
      array (
      ),
